...
export const cursoProgramacaoJavascriptWeb: CursoDetalhado = {
  ...
  unidades: [
    ...
    {
      id: "u3-logica-condicional",
      titulo: "Unidade 3 - Logica condicional",
      descricao: "Controle decisoes com if, else e operadores logicos.",
      ordem: 3,
      modulos: [
        {
          id: "m5-condicionais",
          titulo: "Condicionais",
          descricao: "Faca o programa tomar decisoes.",
          duracaoEstimadaMin: 30,
          xpRecompensa: 130,
          partes: [
            {
    ...
    {
      id: "u4-repeticao",
      titulo: "Unidade 4 - Repeticao",
      descricao: "Use loops para repetir comandos com menos codigo.",
      ordem: 4,
      modulos: [
        {
          id: "m6-loops",
          titulo: "Loops",
          descricao: "Entenda for, while e repeticoes controladas.",
          duracaoEstimadaMin: 35,
          xpRecompensa: 150,
          partes: [
            {
    ...
    {
      id: "u5-funcoes",
      titulo: "Unidade 5 - Funcoes",
      descricao: "Organize codigo em blocos reutilizaveis.",
      ordem: 5,
      modulos: [
        {
          id: "m7-funcoes",
          titulo: "Criando funcoes",
          descricao: "Aprenda parametros, retorno e reutilizacao.",
    ...
    {
      id: "u6-html-css",
      titulo: "Unidade 6 - HTML e CSS",
      descricao: "Monte paginas web com estrutura e estilo.",
      ordem: 6,
      modulos: [
        {
          id: "m8-html-css",
          titulo: "Estrutura e estilo",
          descricao: "Use HTML para organizar e CSS para apresentar conteudo.",
          ...
          partes: [
            {
              id: "p1-texto",
              tipo: "texto_imagem",
              titulo: "HTML, CSS e JavaScript juntos",
              texto: textoParaPreencher,
              imagens: imagemParaPreencher,
            },
            {
    ...
    {
      id: "u7-interatividade",
      titulo: "Unidade 7 - Interatividade na web",
      descricao: "Responda a cliques, formularios e eventos do usuario.",
      ordem: 7,
      modulos: [
        {
          id: "m9-dom-eventos",
          titulo: "DOM e eventos",
          descricao: "Conecte JavaScript aos elementos da pagina.",
          duracaoEstimadaMin: 45,
          xpRecompensa: 180,
          partes: [
            {
    ...
    {
      id: "u8-projeto-final",
      titulo: "Unidade 8 - Projeto final",
      descricao: "Construa um projeto web simples usando tudo que aprendeu.",
      ordem: 8,
      modulos: [
        {
          id: "m10-projeto-final",
          titulo: "Projeto final web",
          descricao:
            "Planeje, implemente e revise um pequeno projeto interativo.",
